...
| `gem-strategies` | **drake-first within 12% of ale-max** at day 120; **gacha-max no more than 18% behind** the better of the two, and ahead of both on pets, frames **and named legendaries** owned. Measured over a **16-seed** pool (widened M9 — see §10); pity trips a pool mean > 8 times, never fewer than 4 on any seed (re-stated M7/M9 — see §10) |
